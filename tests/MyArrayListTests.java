...
public class MyArrayListTests {
	...
	public void testInitial1() {
		...
		assertTrue(testParameters(11, 0, whatShouldArrayListContainNow));
	}
	@Test
	...
	public void testAdd2() {
		...
		assertTrue(testParameters(11, 1, whatShouldArrayListContainNow));
	}
	@Test
	public void testAdd3() {
		...
		whatShouldArrayListContainNow.add(node1);
		whatShouldArrayListContainNow.add(node1);
		assertTrue(testParameters(11, 4, whatShouldArrayListContainNow));
	}
	@Test
	public void testAdd4() {
		...
		assertTrue(testParameters(11, 5, whatShouldArrayListContainNow));
	}
	@Test
	public void testAdd5() {
		...
		whatShouldArrayListContainNow.add(node2);
		whatShouldArrayListContainNow.add(node1);
		assertTrue(testParameters(11, 3, whatShouldArrayListContainNow));
	}
	@Test
	...
	public void testClear2() {	
		...
		whatShouldArrayListContainNow.add(node2);
		whatShouldArrayListContainNow.add(node3);
		assertTrue(testParameters(22, 3, whatShouldArrayListContainNow));
		
		arraylist.clear();
		whatShouldArrayListContainNow.clear();
		assertTrue(testParameters(22, 0, whatShouldArrayListContainNow));	
	}
	@Test
	...
	public void testResize2() {
		resize();
		resize();
		assertTrue(testParameters(44, 0, whatShouldArrayListContainNow));	
		resize();
		assertTrue(testParameters(88, 0, whatShouldArrayListContainNow));	
		resize();
		assertTrue(testParameters(176, 0, whatShouldArrayListContainNow));	
		resize();
		assertTrue(testParameters(352, 0, whatShouldArrayListContainNow));	
	}
	...
	public void testResize3() {
		...
		whatShouldArrayListContainNow.add(node1);
		whatShouldArrayListContainNow.add(node1);
		assertTrue(testParameters(11, 11, whatShouldArrayListContainNow));
		arraylist.add(0, node1);
		whatShouldArrayListContainNow.add(node1);
		assertTrue(testParameters(22, 12, whatShouldArrayListContainNow));
	}
	@Test
	...
	public void testGet2() {
		...
		assertEquals(null, arraylist.get(10));
		assertEquals(null, arraylist.get(11));
		assertTrue(testParameters(11, 0, whatShouldArrayListContainNow));	
	}
	@Test
	...
	public boolean testParameters(int testCapacity, int testSize, ArrayList content) {
		...
		assertEquals(content, arraylist);
